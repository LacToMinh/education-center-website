...
const COURSES_URL = `${import.meta.env.BASE_URL}data/comboThpt.json`;
const SCHEDULE_URL = `${import.meta.env.BASE_URL}schedules/comboThpt.json`;
const ZALO_LINK = "https://zalo.me/0369984849";

const CourseSliderCombo = ({ items }) => {
  const {
    data: coursesData,
  ...
  const courses = coursesData?.dataCombo ?? [];
        ...
        <div className="container !w-full px-0 sm:px-0">
          <Swiper
            ...
            breakpoints={{
              ...
              1024: { slidesPerView: items || 3, spaceBetween: 18 }, // Desktop
              1280: { slidesPerView: items || 4, spaceBetween: 24 }, // Màn rộng
            }}
          >
            {courses.map((c, idx) => (
